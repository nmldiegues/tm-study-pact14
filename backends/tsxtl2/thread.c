...
void sharedWriteHTM(Thread* Self, intptr_t* addr, intptr_t val) {
    HTM_WRITE(addr, val, next_commit);
    *addr = val;
}
void localWriteHTM(Thread* Self, intptr_t* addr, intptr_t val) {
    *addr = val;
}

void freeHTM(Thread* Self, void* ptr){
	free(ptr);
}

void* mallocHTM(Thread* Self, size_t size){
	return malloc(size);
}
...
void localWriteSTM(Thread* Self, intptr_t* addr, intptr_t val) {
    STM_LOCAL_WRITE(addr, val);
}

void freeSTM(Thread* Self, void* ptr){
	STM_FREE(ptr);
}

void* mallocSTM(Thread* Self, size_t size){
...
__thread void (*localWriteFunPtr)(Thread* Self, intptr_t* addr, intptr_t val);
__thread void (*freeFunPtr)(Thread* Self, void* ptr);
__thread void* (*mallocFunPtr)(Thread* Self, size_t size);
